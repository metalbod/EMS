...
# This app has no ORM/SQLAlchemy models — all queries go through db.py's
# raw-SQL wrapper (see db.py, Conn.execute). Migrations here are hand-written
# SQL via op.execute(), matching the codebase's existing style, so there's no
