...
@db_session
def get_employee_eligible_plans(
    conn,
    employee_id: str,
    current_user: dict = Depends(get_current_user),
...
@db_session
def get_active_enrollment_period(
    conn,
    current_user: dict = Depends(get_current_user),
...
@db_session
def auto_enroll_all_active_employees(
    conn,
    plan_id: int,
    current_user: dict = Depends(get_current_user),
) -> dict:
...
@db_session
def attach_dependent_to_enrollment(
    conn,
    enrollment_id: int,
...
@db_session
def list_enrollment_dependents(
    conn,
    enrollment_id: int,
    current_user: dict = Depends(get_current_user),
) -> List[DependentResponse]:
...
@db_session
def detach_dependent_from_enrollment(
    conn,
    enrollment_id: int,
    dependent_id: int,
    current_user: dict = Depends(get_current_user),
